...
The app will inform the user on many common or rare symbol's true meanings and historical significance following the plot of the book "The Da Vinci Code." This program isnt made to advertise the book but that could be a by product of its development. All in all the program is to get people who are interested in the book or people interested with cryptology to have a fun expirience showcasing their abilities while also learning historical glyphs.

<h3>Use Cases</h3>

* User will have to input answers to cryptic clues to continue further in the game

* User can click symbols or items to learn their backstory or give information to provide an answer for a riddle of passage.
